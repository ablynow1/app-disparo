...
export async function DashboardStats() {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      {/* Total de Pedidos */}
      <div className="bg-zinc-900/40 backdrop-blur-xl border border-zinc-800/60 p-6 rounded-3xl shadow-sm relative overflow-hidden group">
...
export function DashboardStatsSkeleton() {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      {[1, 2, 3, 4].map((i) => (
        <div key={i} className="bg-zinc-900/20 backdrop-blur-xl border border-zinc-800/40 p-6 rounded-3xl h-[178px] flex flex-col justify-end animate-pulse">
