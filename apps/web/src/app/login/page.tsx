...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginFormValues) => {
    ...
    try {
      // Usando uma rota de ação ou função fetch se a prop action não cobrir nosso uso do RHF
      ...
      // Se der throw e não for AuthError (Nextjs navigation de redirect é throw tb)
    }
  };
